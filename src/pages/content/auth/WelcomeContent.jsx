  ...
  return (
    <div className = "welcome-hero">
      ...
      <div className="welcome-hero__content">
        ...
        <div onMouseEnter={() => setrandomword0(pickRandom(words0))} style = {{width: '25%', height: '10%', position: 'fixed', top: '20%', left: '55%', fontSize: `${screenwidth / 50}px`, display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'center', transform: `rotate(-15deg) scale(${1 - ticks * 0.01})`}}><span style = {{color: 'rgb(187, 203, 185)'}}>Nauka to</span> <span style = {{color: 'rgb(30, 204, 56)'}}>{randomword0}</span></div>


        <div onMouseEnter={() => setrandomline0(pickRandom(lines0))} style = {{width: '100%', height: '7.5%', position: 'fixed', top: '47.5%', left: '0%', fontSize: `${screenwidth / 65}px`, display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'center'}}><span style = {{color: 'rgb(187, 203, 185)'}}>Witaj, Wędrowcze. Stoisz u bram portalu łączącego uczelnie zrzeszające adeptów wszelkich</span> <span style = {{color: 'rgb(30, 204, 56)'}}>{randomline0}</span></div>
        <div onMouseEnter={() => setrandomline1(pickRandom(lines1))} style = {{width: '100%', height: '7.5%', position: 'fixed', top: '55%', left: '0%', fontSize: `${screenwidth / 65}px`, display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'center'}}><span style = {{color: 'rgb(187, 203, 185)'}}>oraz nauk gotowych zdobywać wiedzę i poszerzać swoje</span> <span style = {{color: 'rgb(30, 204, 56)'}}>{randomline1}</span></div>
        <div onMouseEnter={() => setrandomline2(pickRandom(lines2))} style = {{width: '100%', height: '7.5%', position: 'fixed', top: '62.5%', left: '0%', fontSize: `${screenwidth / 65}px`, display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'center'}}><span style = {{color: 'rgb(187, 203, 185)'}}>w najodleglejszych krainach i czasach. Po drugiej stronie próżno szukać</span> <span style = {{color: 'rgb(30, 204, 56)'}}>{randomline2}.</span></div>
        <div onMouseEnter={() => setrandomline3(pickRandom(lines3))} style = {{width: '100%', height: '7.5%', position: 'fixed', top: '70%', left: '0%', fontSize: `${screenwidth / 65}px`, display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'center'}}><span style = {{color: 'rgb(187, 203, 185)'}}>Ich miejsce zajmują epickie kampanie, sekretne misje oraz ekscytujące</span> <span style = {{color: 'rgb(30, 204, 56)'}}>{randomline3}.</span></div>

        <div onMouseEnter={() => setrandomline4(pickRandom(lines4))} style = {{width: '100%', height: '7.5%', position: 'fixed', top: '80%', left: '0%', fontSize: `${screenwidth / 65}px`, display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'center'}}><span style = {{color: 'rgb(187, 203, 185)'}}>Czy nie brak Ci sprytu i odwagi by przejść do świata, gdzie nauka i przygoda stanowią</span> <span style = {{color: 'rgb(30, 204, 56)'}}>{randomline4}?</span></div>


          <div style = {{width: '100%', height: '10%', position: 'fixed', top: '32.5%', left: '0%', fontSize: '70px', display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'center'}}><span style = {{color: 'rgb(187, 203, 185)'}}>MyAcademy</span><span style = {{color: 'rgb(30, 204, 56)'}}>Quest</span></div>
        <Link to = {loginPath()}>
            <div onMouseEnter={(event) => {setrandomword1(pickRandom(words1)); event.currentTarget.style.backgroundColor = 'rgba(30, 204, 56, 0.2)';}} onMouseLeave={(event) => (event.currentTarget.style.backgroundColor = 'rgba(30, 204, 56, 0.1)')} style = {{backgroundColor: 'rgba(30, 204, 56, 0.1)', width: '20%', height: '10%', position: 'fixed', top: '2.5%', left: '77.5%', fontSize: `${screenwidth / 65}px`, display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'center', color: 'rgb(187, 203, 185)', borderRadius: '32px'}}><span style = {{color: 'rgb(187, 203, 185)'}}>Zanurz się w</span> <span style = {{color: 'rgb(30, 204, 56)'}}>{randomword1}</span></div>
        </Link>
      </div>
