    ...
    <main>
      <div>
        <div style = {{backgroundColor: 'rgb(40, 40, 52)', width: '98%', height: '98%', position: 'absolute', top: '1%', left: '1%', borderBottom: '4px solid rgb(66, 243, 125)', borderRadius: '16px'}}>
          <div style = {{width: '49%', height: '10%', position: 'absolute', top: '3%', left: '1%', fontSize: '300%', display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '1%'}}><span style={{color: 'rgb(227, 224, 247)'}}>Kreator</span> <span style={{color: 'rgb(66, 243, 125)'}}>Grupy</span></div>
          <div style = {{width: '98%', height: '5%', position: 'absolute', top: '13%', left: '1%', color: 'rgb(187, 203, 185)', fontSize: '100%', display: 'flex', fontWeight: 500, alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '1%'}}><span>W celu utworzenia nowej grupy prosze wprowadzic nazwe i opis.</span></div>
          ...
          <div style = {{backgroundColor: 'rgb(26, 26, 42)', width: '98%', height: '40%', position: 'absolute', top: '20%', left: '1%', borderRadius: '16px'}}>
            <div style = {{width: '98%', height: '15%', position: 'absolute', top: '5%', left: '1%', color: 'rgb(66, 243, 125)', fontSize: '150%', display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '0%'}}><span>Grupa</span></div>
            <div style = {{width: '48.5%', height: '10%', position: 'absolute', top: '20%', left: '1%', fontSize: '100%', display: 'flex', fontWeight: 500, alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '0%'}}><span style={{color: 'rgb(187, 203, 185)'}}>Nazwa grupy</span> <span style={{color: 'rgb(153, 41, 42)'}}>{groupnamevalueerror}</span></div>
            ...
            <div style = {{width: '48.5%', height: '10%', position: 'absolute', top: '60%', left: '1%', color: 'rgb(187, 203, 185)', fontSize: '100%', display: 'flex', fontWeight: 500, alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '0%'}}><span style={{color: 'rgb(187, 203, 185)'}}>Nazwa przedmiotu</span> <span style={{color: 'rgb(153, 41, 42)'}}>{subjectnamevalueerror}</span></div>
            ...
            <div style = {{width: '48.5%', height: '10%', position: 'absolute', top: '20%', left: '50.5%', fontSize: '100%', display: 'flex', fontWeight: 500, alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '0%'}}><span style={{color: 'rgb(187, 203, 185)'}}>Baner grupy</span></div>
          ...
          <div style = {{width: '96%', height: '5%', position: 'absolute', top: '60%', left: '2%', color: 'rgb(187, 203, 185)', fontSize: '100%', display: 'flex', fontWeight: 500, alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '0%'}}><span style={{color: 'rgb(187, 203, 185)'}}>Opis grupy</span> <span style={{color: 'rgb(153, 41, 42)'}}>{subjectnamevalueerror}</span></div>
        </div>
