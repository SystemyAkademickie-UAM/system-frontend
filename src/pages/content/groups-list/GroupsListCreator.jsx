...
export default function App({popupclose}) {
  ...
  return isVisible ? (
    <main>
      ...
      <div onClick = {onRemovebannerclick} style = {{backgroundColor: 'rgba(26, 26, 42)', width: '10%', height: '7.5%', position: 'absolute', top: '65%', left: '87%', borderRadius: '8px', color: 'rgb(187, 203, 185)', fontSize: '14px', display: 'flex', fontWeight: 900, alignItems: 'center', justifyContent: 'center', textAlign: 'center', cursor: 'pointer'}}>Usun baner</div>
    </main>
  ) : null;
}
