...
import { SAML_BYPASS_LECTURER_PATH, SAML_BYPASS_STUDENT_PATH } from './constants/apiPaths.constants.js';
  ...
  return (
    <main className="app app--wide">
      ...
      <p className="app__nav">
        <a className="app__saml-link" href="/">
          ← Home
        </a>
      </p>

      <section className="smoke__fieldset" aria-labelledby="bypass-heading">
        <h2 id="bypass-heading">Dev SAML bypass</h2>
        <p className="smoke__hint">
          ...
          <strong>same host</strong> as this UI (e.g. <code className="smoke__code">http://127.0.0.1:3000/test</code> when the app is on{' '}
